        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmissionAmount = table.Column<double>(type: "double precision", nullable: false),
                    AppUserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmissionRecord", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "109f6a78-52cd-437f-b2ed-dce18073e023", null, "Admin", "ADMIN" },
                    { "24abc538-2139-4809-b932-25fd3f7d6162", null, "User", "USER" },
                    { "29ddd244-4dec-481b-8b73-718c79efa140", null, "Company", "COMPANY" }
                });
